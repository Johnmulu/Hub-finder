        ...
        <div class ="card card-body mb-3">
            <div class ="row">
                ...
                <div class ="col-md-9">
                    ...
                    <span class = "badge bg-secondary mb-2">Public Gists: ${user.public_repos}</span>
                ...
                <div class ="card card-body mb-2">
                    <div class="row">
                        ...
                        <div class ="col-md-6">
                            ...
                            <span class = "badge bg-primary mb-2"> Watchers: ${repo.watchers_count}</span>
                            <span class = "badge bg-primary mb-2">Forks: ${repo.forms_count}</span>
                        </div>
                    </div>
                </div>
            `;
